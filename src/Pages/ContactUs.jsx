  ...
  return (
    <div>
      ...
      <div className="w-3/4 mx-auto flex justify-center text-center">
        <div className="flex flex-col flex-1 gap-y-3 p-10 m-10" style={{ backgroundColor: '#79E018' }}>
          <img
      ...
      <div className="flex">
        <div className="flex-1 h-full">
          <img className="w-full h-96 object-cover object-center"
            src="public/assets/homemade-salad.jpg" />
        </div>
        <div className="flex flex-col flex-1 text-center h-96 gap-y-10 bg-black justify-center">
          <h2 className="text-3xl font-poppins font-bold text-white">Masih memiliki pertanyaan?</h2>
