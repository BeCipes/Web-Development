...
const About = () => {
  return (
    <div className="Poppins">
      ...
      <div className="flex w-full items-center justify-center flex-col pt-24  pb-24">
        <div className="flex items-center justify-center w-full ">
          <div className="text-center w-1/2 px-20 text-black">
            ...
            <a href="/panduan">
              <button className=" bg-grab mt-7 rounded-full px-5 py-5 text-black hover:bg-slate-100">
                Panduan Pengguna
              </button>
            </a>
          </div>
      ...
      <div
        className="carousel relative rounded-box mx-10 space-x-7  mt-20 mb-20"
        style={{ zIndex: 0 }}
      >
        <div id="slide1" className="carousel-item relative">
          <img
            ...
            alt="Burger"
            className="rounded-box w-80 h-3/4"
          />
        </div>
