  ...
  return (
    <div className="Poppins">
      ...
      <div className="flex w-full items-center justify-center flex-col pt-24  pb-24">
        <div className="flex items-center justify-center w-full ">
          <div className="text-center w-1/2 px-20 text-black">
            ...
            <button className=" bg-grab mt-7 rounded-full px-5 py-5 text-black">Panduan Pengguna</button>
          </div>
      ...
      <div className="text-center text-black justify-center mt-20 ">
        <h1 className="text-3xl font-poppins mt-5 font-semibold">Tim Developer</h1>
      </div>

      <div className="carousel relative rounded-box mx-10 space-x-7  mt-20 mb-20" style={{ zIndex: 0 }}>
        <div id="slide1" className="carousel-item relative">
          <img src="public/assets/foto kelompok/dila.jpg" alt="Burger" className="rounded-box w-80 h-3/4" />
        </div> 

        <div id="slide2" className="carousel-item relative ">
          <img src="public/assets/foto kelompok/alfin.jpeg" alt="Burger" className="rounded-box w-80 h-3/4" />
        </div> 

        <div id="slide3" className="carousel-item relative">
          <img src="public/assets/foto kelompok/aina fazla.jpg" alt="Burger" className="rounded-box w-80 h-3/4" />
        </div> 

        <div id="slide4" className="carousel-item relative">
          <img src="public/assets/foto kelompok/rizka hilmi.jpg" alt="Burger"  className="rounded-box w-80 h-3/4"/>
          <div className="absolute top-1/3 transform -translate-y-1/2 right-0">
        ...
        <div id="slide5" className="carousel-item">
          <img src="public/assets/foto kelompok/kayla.jpg" alt="Burger" className="rounded-box w-80 h-3/4" />
        ...
        <div  id="slide6" className="carousel-item">
          <img src="public/assets/foto kelompok/mutiara sabrina.jpg" alt="Burger" className="rounded-box w-80 h-3/4"/>
        </div> 

        <div id="slide7" className="carousel-item">
          <img src="public/assets/foto kelompok/austin.jpg" alt="Burger" className="rounded-box w-80 h-3/4" />
        </div>

        <div id="slide8" className="carousel-item relative">
          <img src="public/assets/foto kelompok/adit.jpg" alt="Burger" className="rounded-box w-80 h-3/4"/>
          <div className="absolute top-1/3 right-0 transform -translate-y-1/2">
            <a href="#slide11" className="btn btn-circle text-black bg-white border-none hover:bg-white">
              ❯
            </a>
          </div>
        </div>
        ...
        <div id="slide9" className="carousel-item">
          <img src="public/assets/foto kelompok/dito.jpg" alt="Burger" className="rounded-box w-80 h-3/4" />
          <div className="absolute top-1/3 transform -translate-y-1/2 -right-30">
        ...
        <div id="slide10" className="carousel-item">
          <img src="public/assets/foto kelompok/ikhsan.jpg" alt="Burger" className="rounded-box w-80 h-3/4"/>
        </div> 

        <div id="slide11" className="carousel-item">
          <img src="public/assets/foto kelompok/firdaus.jpg" alt="Burger" className="rounded-box w-80 h-3/4" />
        </div>
      </div>
