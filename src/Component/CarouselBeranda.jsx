  ...
  return (
    <div className="carousel w-full">
      <div id="slide1" className="carousel-item relative w-full">
        <div
          className="carousel relative rounded-box mx-16 space-x-6 "
          style={{ zIndex: 0 }}
        >
            ...
            <div className="card card-compact w-72 bg-black shadow-xl">
              ...
              <div className="card-body items-center text-center h-1/2">
                ...
                <p className="mb-3 mt-3 text-white">
                  Sandwich vegan terbuat dari roti gandum baik dikonsumsi untuk
                  memperbaiki nutrisi tubuh. Kandungan sayur di dalamnya juga
                  memberikan manfaat yang baik bagi tubuh Anda.
                </p>
          ...
          <div className="carousel-item relative">
            <div className="card card-compact w-72 bg-black shadow-xl">
              ...
              <div className="card-body items-center text-center h-1/2">
                ...
                <p className="mb-3 mt-3 text-white">
                  Kol ungu bermanfaat untuk pengurangan peradangan, jantung yang
                  lebih sehat, tulang yang lebih kuat, fungsi usus yang lebih
                  baik, dan bahkan risiko kanker yang lebih rendah.
                </p>
                <div className="card-actions justify-end">
                  <button className="btn bg-grab border-none rounded-3xl px-10 text-hitam">
                    Resep
          ...
          <div className="carousel-item relative">
            <div className="card card-compact w-72 bg-black shadow-xl">
              ...
              <div className="card-body items-center text-center h-1/2">
                ...
                <p className="mb-3 mt-3 text-white">
                  Banana Pancake merupakan camilan sehat favorit keluarga. Cara
                  membuat pancake pisang sederhana dengan resep yang mudah
                  didapat.
                </p>
                <div className="card-actions justify-end">
        ...
        <div className="absolute flex justify-between transform -translate-y-1/2 left-10 right-10 top-1/2">
          <a href="#slide3" className="btn bg-grab border-none btn-circle">
            ❮
          </a>
          <a href="#slide2" className="btn bg-grab border-none btn-circle">
            ❯
          </a>
        </div>
      </div>
      ...
      <div id="slide2" className="carousel-item relative w-full">
            ...
            <div className="card card-compact w-72 bg-black shadow-xl">
              ...
              <div className="card-body items-center text-center h-1/2">
                ...
                <p className="mb-3 mt-3 text-white">
                  ...
                  akan vitamin, mineral, serat yang baik bagi sistem pencernaan
                  Anda.
                </p>
                <div className="card-actions justify-end">
                  <button className="btn bg-grab border-none rounded-3xl px-10 text-hitam">
        ...
        <div className="absolute flex justify-between transform -translate-y-1/2 left-10 right-10 top-1/2">
          <a href="#slide1" className="btn btn-circle bg-grab border-none">
            ❮
          </a>
          <a href="#slide3" className="btn btn-circle bg-grab border-none">
            ❯
          </a>
        </div>
      </div>
      ...
      <div id="slide3" className="carousel-item relative w-full">
          ...
          <div className="carousel-item relative">
            <div className="card card-compact w-72 bg-black shadow-xl">
              ...
              <div className="card-body items-center text-center h-1/2">
                ...
                <p className="mb-3 mt-3 text-white">
                  Alpukat kaya akan vitamin K dan juga memberikan energi bagi
                  tubuh Anda. Kandungan alpukat juga mengandung asam lemak sehat
                  dan mengandung serat tinggi.
                </p>
                <div className="card-actions justify-end">
                  <button className="btn bg-grab border-none rounded-3xl px-10 text-hitam">
                    Resep
          ...
          <div className="carousel-item relative">
            <div className="card card-compact w-72 bg-black shadow-xl">
              ...
              <div className="card-body items-center text-center h-1/2">
                ...
                <p className="mb-3 mt-3 text-white">
                  Hidangan Shrimp Spring Roll, atau juga dikenal sebagai Lumpia
                  Udang atau Goi Cuon, memiliki beberapa manfaat kesehatan dan
                  nutrisi.
                </p>
                <div className="card-actions justify-end">
                  <button className="btn bg-grab border-none rounded-3xl px-10 text-hitam">
        ...
        <div className="absolute flex justify-between transform -translate-y-1/2 left-10 right-10 top-1/2">
          <a href="#slide2" className="btn btn-circle bg-grab border-none">
            ❮
          </a>
          <a href="#slide1" className="btn btn-circle bg-grab border-none">
            ❯
